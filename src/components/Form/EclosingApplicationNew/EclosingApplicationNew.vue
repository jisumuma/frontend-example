<template>
  <div>
    <section class="content-header">
      <h1 style="font-size:22px;">E-Closing (HRECL) 离职</h1>
      <ol class="breadcrumb" v-if="approvalFlow">
        ...
        <li><a >8.Finance Cashier</a></li>
        <li><a >9.HRBP Preparation</a></li>
      </ol>
      <ol class="breadcrumb" v-if="!approvalFlow">
        <li><a >1.Applicant</a></li>
        <li><a :title="titleParallel" href="###" >2.Confirmation Parallel</a></li>
        <li><a >3.Finance Cashier</a></li>
        <li><a >4.HRBP Preparation</a></li>
      </ol>
    ...
    <div class="box box-primary" v-if="showResignationInfoAll">
      ...
      <form role="form">
            ...
            <form-group col="md-3" v-show="this.form.ifNoFse" type="select" :disabled="lastWorkingReadonly" :other-rules="otherRulesNoFse" uri="/eclosingApplicationNew/reasonlist?groupName=ResignationType" v-model="form.resignationType" name="resignationType" label="EclosingApplication.resignationType"/>
            <form-group col="md-3" v-show="this.form.ifFse" type="select" :disabled="lastWorkingReadonly" :other-rules="otherRulesFse" uri="/eclosingApplicationNew/reasonlist?groupName=ResignationTypeForFse" v-model="form.resignationType" name="resignationType" label="EclosingApplication.resignationType"/>
            ...
            <form-group col="md-3" type="select" :disabled="lastWorkingReadonly" other-rules="required" uri="/eclosingApplicationNew/reasonlist?groupName=CompanyCar" v-model="form.boolCompanyCar" name="boolCompanyCar" label="EclosingApplication.boolCompanyCar"/>
            <div class="col-md-9">
              <div class="form-group">
                <label for=""> &nbsp;  </label>
              ...
              <table id="EHSTable" class="table table-bordered table-hover table-permanent-position">
                <tbody>
                  ...
                  <tr v-if="this.ehsOhcTrDisplay">
                    ...
                    <td class="text-center is-safe ">
                      <form-group type="select" haslable="false" :disabled="readonlyHrbpPreparation || deputyEhsOhc" other-rules="required" uri="/eclosingApplicationNew/reasonlist?groupName=Occupational Physical Examination" v-model="form.boolExamination" name="boolExamination"/>
                      <!--
            ...
            <div class="form-group col-md-6">
              <table id="TrainingTable" class="table table-bordered table-hover table-permanent-position">
                <tbody>
                  ...
                  <tr>
                    <td class="is-safe">Training Expense Settlement 培训费用清算扣款 <!--Training Expense Refund 培训费用返还金额--></td>
                    <td class="text-center is-safe">
              ...
              <table id="HRBPTable" class="table table-bordered table-hover table-permanent-position">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center is-safe">
                      <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrbp" v-model="form.boolAnnualLeave" name="boolAnnualLeave" id="boolAnnualLeave" value="Yes">
                    </td>
                    <!--
                    <td class="text-center is-safe">
                      <div class="form-group">
                    ...
                    <td class="is-safe">Hukou Bond Settlement 户口绑定清算扣款
                      <!--Hukou Bond Refund 户口绑定返还金额-->
                    </td>
                    <td class="text-center is-safe">
                  ...
                  <tr>
                    ...
                    <td class="text-center is-safe">
                      <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrbp" v-model="form.boolOvertime" name="boolOvertime" id="boolOvertime" value="Yes">
                    </td>
                    <!--
                    <td class="text-center is-safe">
                      <div class="form-group">
      ...
      <div class="box-header with-border">
		...
		<form role="form" id="collapseHRCB" :class="this.formClassCollapse">
			<div class="box-body">
					...
					<div class="form-group col-md-12">
						<table id="HrcbTable" class="table table-bordered table-hover table-permanent-position">
							<tbody>
								...
								<tr>
									<td class="is-safe">Salary Before Tax 应付工资（税前） </td>
									<td class="text-center is-safe">
									  <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.boolNetPay" name="boolNetPay" id="boolNetPay" value="Yes">
									</td>
									<td class="text-center is-safe">
									  <div class="form-group">
                      <input style="width: 70%" :disabled="readonlyHrbpPreparation || deputyHrcb" @change="oninputHrcb"  type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="netPayRemark" id="netPayRemark" v-model="form.netPayRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
									  </div>
									</td>
									<td class="is-safe" v-if="this.form.ifLc">Other Deductions (if any) 其他扣减项（如有）</td>
									<td class="text-center is-safe" v-if="this.form.ifLc">
									  <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.boolDeductions" name="boolDeductions" id="boolDeductions" value="Yes">
									</td>
									<td class="text-center is-safe" v-if="this.form.ifLc">
									  <div class="form-group">
										<input style="width: 70%" :disabled="readonlyHrbpPreparation || deputyHrcb" @change="oninput" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="otherDeductionsRemark" id="otherDeductionsRemark" v-model="form.otherDeductionsRemark" placeholder="Amount" >
										<div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
									  </div>
									</td>
                  <td class="is-safe" v-if="this.form.ifFseLe">Social Insurance by 社会保险至 
                    <select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.socialInsuranceYear" name="socialInsuranceYear" >
											<option value="-">-</option>
                    ...
                    <form-group type="select" style="width: 160px;" :disabled="readonlyHrbpPreparation" haslable="false" other-rules="required" uri="/eclosingApplicationNew/reasonlist?groupName=Month" v-model="form.socialInsuranceMonth" name="socialInsuranceMonth" label="EclosingApplication.socialInsuranceMonth" />   
                    -->
                    <select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.socialInsuranceMonth" name="socialInsuranceMonth" >
                ...
                <tr v-if="this.form.ifFseLe">
                  <td class="is-safe">Home Leave Refund 探亲假扣款</td>
									<td class="text-center is-safe">
									  <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.boolHomeLeaveRefund" name="boolHomeLeaveRefund" id="boolHomeLeaveRefund" value="Yes">
									</td>
									<td class="text-center is-safe">
									  <div class="form-group">
										<input style="width: 70%" :disabled="readonlyHrbpPreparation || deputyHrcb" @change="oninput" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="homeLeaveRefundRemark" id="homeLeaveRefundRemark" v-model="form.homeLeaveRefundRemark" placeholder="Amount" >
										<div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
									  </div>
									</td>
                  <td class="is-safe">Relocation Refund 入离职费用扣款</td>
									<td class="text-center is-safe">
									  <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.boolRelocationRefund" name="boolRelocationRefund" id="boolRelocationRefund" value="Yes">
									</td>
									<td class="text-center is-safe">
									  <div class="form-group">
										<input style="width: 70%" :disabled="readonlyHrbpPreparation || deputyHrcb" @change="oninput" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="relocationRefundRemark" id="relocationRefundRemark" v-model="form.relocationRefundRemark" placeholder="Amount" >
										<div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
									  </div>
									</td>
                </tr>
                <tr v-if="this.form.ifFseLe">
                  <td class="is-safe">Reconciliation Tax Refund 个税汇算清缴扣款</td>
									<td class="text-center is-safe">
									  <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.boolReconciliationTaxRefund" name="boolReconciliationTaxRefund" id="boolReconciliationTaxRefund" value="Yes">
									</td>
									<td class="text-center is-safe">
									  <div class="form-group">
										<input style="width: 70%" :disabled="readonlyHrbpPreparation || deputyHrcb" @change="oninput" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="reconciliationTaxRefundRemark" id="reconciliationTaxRefundRemark" v-model="form.reconciliationTaxRefundRemark" placeholder="Amount" >
										<div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
									  </div>
									</td>
                  <td class="is-safe">Ancillary Housing Service Deduction 房屋附加费扣款</td>
									<td class="text-center is-safe">
									  <input type="checkbox" :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.boolAncillaryHousing" name="boolAncillaryHousing" id="boolAncillaryHousing" value="Yes">
									</td>
									<td class="text-center is-safe">
									  <div class="form-group">
										<input style="width: 70%" :disabled="readonlyHrbpPreparation || deputyHrcb" @change="oninput" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="ancillaryHousingRemark" id="ancillaryHousingRemark" v-model="form.ancillaryHousingRemark" placeholder="Amount" >
										<div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
									  </div>
									</td>
                </tr>
								...
								<!--<tr >
									<td class="is-safe">Social Insurance 社会保险</td>
									<td class="text-center is-safe">
                    ...
                    年
                    <!--
										<input :class="{'is-danger': errors.has('socialInsuranceYear') }" type="text" @change="oninputNumYear" :disabled="readonlyHrbpPreparation" v-model="form.socialInsuranceYear" name="socialInsuranceYear" style="width: 15%" />年
										-->
                    <select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.socialInsuranceMonth" name="socialInsuranceMonth" >
											<option value="-">-</option>
                      <option value="1">1</option>
                    ...
                    <select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.housingFundYear" name="housingFundYear" >
											<option value="-">-</option>
                      <option value="2019">2019</option>
                      <option value="2020">2020</option>
                      <option value="2021">2021</option>
                    ...
                    <!--
										<input :class="{'is-danger': errors.has('housingFundYear') }" type="text" @change="oninputNumYear" :disabled="readonlyHrbpPreparation" v-model="form.housingFundYear" name="housingFundYear" style="width: 15%" />
                    -->
                    年
										<select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.housingFundMonth" name="housingFundMonth" >
											<option value="-">-</option>
                      <option value="1">1</option>
											<option value="2">2</option>
											<option value="3">3</option>
                ...
                <tr style="height:50px" v-if="this.form.ifLc">
									<td class="is-safe">Enterprise Annuity by 企业年金至 
                    <select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.enterpriseAnnuityYear" name="enterpriseAnnuityYear" >
											<option value="-">-</option>
                      <option value="2019">2019</option>
                      <option value="2020">2020</option>
                      <option value="2021">2021</option>
                    ...
                    <!--
										<input :class="{'is-danger': errors.has('enterpriseAnnuityYear') }" type="text" @change="oninputNumYear" :disabled="readonlyHrbpPreparation" v-model="form.enterpriseAnnuityYear" name="enterpriseAnnuityYear" style="width: 15%" />
                    -->
                    年
										<select :disabled="readonlyHrbpPreparation || deputyHrcb" v-model="form.enterpriseAnnuityMonth" name="enterpriseAnnuityMonth" >
											<option value="-">-</option>
                      <option value="1">1</option>
											<option value="2">2</option>
											<option value="3">3</option>
        ...
        <div class="row">
          <form-group col="md-3" type="input" v-model="form.netPayFinal" name="netPayFinal" disabled="true" label="EclosingApplication.netPayFinalNew"></form-group>
    ...
    <div class="box box-primary" id="financeCashierDiv" v-if="this.financeCashierDisplay">
      ...
      <form role="form" id="collapseCahier" :class="this.formClassCollapse">
            ...
            <div class="form-group col-md-12">
              <table id="CahierTable" class="table table-bordered table-hover table-permanent-position">
                <tbody>
                  ...
                  <tr>
                    <td class="is-safe">C&B Salary Settlement C&B 工资类扣款</td>
                    <td class="text-center is-safe">
                      <div class="form-group">
                    ...
                    <td class="is-safe">Hukou Bond Settlement 户口绑定清算扣款</td>
                    <td class="text-center is-safe">
                      <div class="form-group">
                  ...
                  <tr>
                    <td class="is-safe">Training Expense Settlement 培训费用清算扣款</td>
                    <td class="text-center is-safe">
                      <div class="form-group">
                  ...
                  <tr ><!--v-if="this.otherDeductionDisplay" -->
                    <td class="is-safe">
                      Other Deductions 其他扣款
                      <i class="fa fa-fw fa fa-search text-info" title="Details 详情" @click="startProcess" style="font-size:14px;"></i>  
                    </td>
                    <td class="is-safe">
                      <div class="form-group">
                        <input style="width: 70%" :readonly="readonly" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="deductions" id="deductions" v-model="form.deductions" placeholder="Amount" >
                        <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                      </div>
                    </td>
                    <td colspan="2" class="is-safe"></td>
                  </tr>
                  <!--
                  <tr>
                    <td class="is-safe">Total Amount of Deductions 总扣款金额</td>
                    <td class="text-center is-safe">
                      <div class="form-group">
          ...
          <div class="row">
            <form-group col="md-3" type="input" v-model="form.totalAmount" name="totalAmount" disabled="true" label="EclosingApplication.totalAmount"></form-group>
          </div>
          <!--
          <div class="row">
    ...
    <!--width:1000px;height:350px;top:60%; -->
    <div class="modal fade" style="position: fixed;width:100%;height:100%;" id="ruleModal" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" id="ruleModal2" :style="modelstyle" role="document"><!--margin-top: 15%; margin-top: -151px;-->
        <div class="modal-content" style="overflow-y:auto;">
          ...
          <div class="modal-body">
            <div style="float:left;width: 50%;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.employeeCardRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Employee Card 员工卡</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="employeeCardRemark" id="employeeCardRemark" v-model="form.employeeCardRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.officeKeyRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Office Key (if any) 办公室钥匙（如有）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="officeKeyRemark" id="officeKeyRemark" v-model="form.officeKeyRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.officeDrawerKeyRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Office Drawer Key 办公室抽屉钥匙</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="officeDrawerKeyRemark" id="officeDrawerKeyRemark" v-model="form.officeDrawerKeyRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.companyCarRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Company Car 公务车</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="companyCarRemark" id="companyCarRemark" v-model="form.companyCarRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.dormitoryRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Dormitory Check-out (if any) 宿舍退宿（如有）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="dormitoryRemark" id="dormitoryRemark" v-model="form.dormitoryRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.lockeKeyRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Key of Locker (if any) 更衣柜钥匙（如有）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="lockeKeyRemark" id="lockeKeyRemark" v-model="form.lockeKeyRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.clothesRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Work Clothes 工服</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="clothesRemark" id="clothesRemark" v-model="form.clothesRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.handbookRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Employee Handbook 归还员工手册</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="handbookRemark" id="handbookRemark" v-model="form.handbookRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.homeLeaveAccountRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Settlement of Home Leave Budget Account 结算探亲预算</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="homeLeaveAccountRemark" id="homeLeaveAccountRemark" v-model="form.homeLeaveAccountRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.mobilePhoneRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Company Mobile Phone (if have) 归还公司手机（如有）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="mobilePhoneRemark" id="mobilePhoneRemark" v-model="form.mobilePhoneRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.pcRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Company Computer (Desktop/ Laptop/ Monitor) 归还电脑（台式机/笔记本/显示器）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="pcRemark" id="pcRemark" v-model="form.pcRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.otherAssetsRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Return Other Company Assets (Pad/ Mobile hard disk/ USB stick…) 其它公司财产（如Pad/移动硬盘/USB…等）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="otherAssetsRemark" id="otherAssetsRemark" v-model="form.otherAssetsRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
            ...
            <div style="float:left;width: 50%;height:34.3px;margin-top:5px;margin-bottom:5px;padding-left:2px;" v-if="form.settlementCallCostRemark">
              <table style="width: 100%;">
                <tr>
                  <td style="width: 60%">Settlement of Private Call Cost (FSE only) 结算私人话费（仅适用于FSE）</td>
                  <td style="width: 38%">
                    <div class="form-group">
                      <input style="width: 70%" disabled="true" type="text" :class="{'form-control':true,'pull-left': true,'input':true  }" name="settlementCallCostRemark" id="settlementCallCostRemark" v-model="form.settlementCallCostRemark" placeholder="Amount" >
                      <div class="pull-left" style="height:34px;width:30%;position:relative;line-height: 32px;border:1px solid #d2d6de; text-align:center;">&nbsp;RMB</div>
                    </div>
                  </td>
                  <td style="width: 2%">&nbsp;</td>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-dismiss="modal"  @click="closeModel()" >Close</button>
          </div>-->
        </div>
      </div>
    </div>
      ...
      <ConfirmwithsaveShow id="EclosingApplicationS" entityId="EclosingApplicationNew" v-if="this.confirmwithsaveBtn && form.status != 9 && form.status != 2 && (this.$route.path.indexOf('audit') > -1 || this.$route.path.indexOf('reAudit') > -1)" :form="form" :validator="this.$validator" lableName="Confirm" uri="/eclosingApplicationNew/save" v-on:beforeapprovel="beforeapprovel" v-on:beforesubmit="beforesubmit"></ConfirmwithsaveShow>
      <!-- Direct supervisor 无save 有reject-->
      <Confirmwithreject entityId="EclosingApplicationNew" v-else-if="this.confirmRejectBtn  && deputySelfApprove && form.status != 9 && form.status != 2 && (this.$route.path.indexOf('audit') > -1 || this.$route.path.indexOf('reAudit') > -1)" :form="form" :validator="this.$validator" lableName="Confirm" rejectLableName="Reject" uri="/eclosingApplicationNew/save" v-on:beforeapprovel="beforeapprovel" v-on:beforesubmit="beforesubmit"></Confirmwithreject>
      <!-- Head of HR Operation的approve\back按钮 -->
      <ConfirmShow id="EclosingApplicationC" entityId="EclosingApplicationNew" v-else-if="this.confirmBtn && form.status != 9 && form.status != 2 && (this.$route.path.indexOf('audit') > -1 || this.$route.path.indexOf('reAudit') > -1)" :form="form" :validator="this.$validator" lableName="Confirm" uri="/eclosingApplicationNew/save" v-on:beforeapprovel="beforeapprovel" v-on:beforesubmit="beforesubmit"></ConfirmShow>
      
      <!-- 平行审批HRBP的save\approve\print\back按钮  -->
      <ConfirmwithSavePrint id="EclosingApplicationSP" entityId="EclosingApplicationNew" v-else-if="this.confirmwithSavePrintBtn && form.status != 9 && form.status != 2 && (this.$route.path.indexOf('audit') > -1 || this.$route.path.indexOf('reAudit') > -1)"  :form="form" :validator="this.$validator" lableName="Confirm" uri="/eclosingApplicationNew/save" v-on:beforeapprovel="beforeapprovel" v-on:beforesubmit="beforesubmit"></ConfirmwithSavePrint>
      
      <!-- 最后一步 HRBP preparation 审批的 approve\print\back按钮-->
      <ConfirmWithPrint id="EclosingApplicationCP" entityId="EclosingApplicationNew" v-else-if="this.confirmWithPrintBtn && form.status != 9 && form.status != 2 && (this.$route.path.indexOf('audit') > -1 || this.$route.path.indexOf('reAudit') > -1)"  :form="form" :validator="this.$validator" lableName="Confirm" uri="/eclosingApplicationNew/save" v-on:beforeapprovel="beforeapprovel" v-on:beforesubmit="beforesubmit"></ConfirmWithPrint>

      <router-view id="EclosingApplicationSubmit" v-else :form="form" entityId="EclosingApplicationNew" approveLableName="Confirm" vclass="btn-left" uri="/form/EclosingApplicationNew/update" :validator="this.$validator"  v-on:beforesubmit="beforesubmit" v-on:beforeapprovel="beforeapprovel"></router-view>      
...
export default {
  ...
  methods: {
    ...
    this.selectanemployee = temp;
		if(!temp){
			var me = this;
			this.GL.actUtil.query("post","/eclosingApplicationNew/selfApply?eclId="+this.form.id,"",function(data){
  ...
  doAfterSelectOtherPerson: function(data) {
    ...
    var ticketNoOld = this.form.ticketNo
		this.GL.actUtil.query("get","/eclosingApplicationNew/selectOne/"+data.id+"?eclId="+eclId,"",function(data){
  ...
  //离职原因调用显示具体原因框
    ...
    oninputNumYear:function(e){
      ...
      //企业年金 
      if(this.form.enterpriseAnnuityYear != null && this.form.enterpriseAnnuityYear !=""){
        this.form.enterpriseAnnuityYear = this.form.enterpriseAnnuityYear.replace("-","");
        var enterpriseAnnuityYear = this.form.enterpriseAnnuityYear;
        if(!/^\d{4}$/.test(enterpriseAnnuityYear)){
          $.alertApon("Please enter the correct year 请输入正确的年份");
          this.form.enterpriseAnnuityYear="";
          return;
        }
        var date = new Date();
        var max = date.getFullYear()+1;//当前年份+1
        var min = date.getFullYear();//当前年份
        //var n = new Number(year);
        if ((enterpriseAnnuityYear.valueOf() > max) || (enterpriseAnnuityYear.valueOf() < min)) {
          $.alertApon('Please enter the correct time range 请输入正确的时间范围');
          this.form.enterpriseAnnuityYear="";
          return;
        }
    ...
    oninput:function(e){
      ...
      if(this.form.homeLeaveRefundRemark != null){
        var newnum = this.formatCurrency2(this.form.homeLeaveRefundRemark);
        this.form.homeLeaveRefundRemark=newnum;
      }
      if(this.form.relocationRefundRemark != null){
        var newnum = this.formatCurrency2(this.form.relocationRefundRemark);
        this.form.relocationRefundRemark=newnum;
      }
      if(this.form.reconciliationTaxRefundRemark != null){
        var newnum = this.formatCurrency2(this.form.reconciliationTaxRefundRemark);
        this.form.reconciliationTaxRefundRemark=newnum;
      }
      if(this.form.ancillaryHousingRemark != null){
        var newnum = this.formatCurrency2(this.form.ancillaryHousingRemark);
        this.form.ancillaryHousingRemark=newnum;
      }
      if(this.form.otherDeductionsRemark != null){
        var newnum = this.formatCurrency2(this.form.otherDeductionsRemark);
    ...
    oninputHrcb:function(e){
        ...
        if(this.form.ifFseLe){
          //计算
          var homeLeaveRefundRemark="";
          if(this.form.homeLeaveRefundRemark !=null){
            homeLeaveRefundRemark=this.form.homeLeaveRefundRemark.replace(/,/g, '');//先去除千分符
          }else{
            homeLeaveRefundRemark="0";
          }

          var relocationRefundRemark="";
          if(this.form.relocationRefundRemark !=null){
            relocationRefundRemark=this.form.relocationRefundRemark.replace(/,/g, '');//先去除千分符
          }else{
            relocationRefundRemark="0";
          }

          var reconciliationTaxRefundRemark="";
          if(this.form.reconciliationTaxRefundRemark !=null){
            reconciliationTaxRefundRemark=this.form.reconciliationTaxRefundRemark.replace(/,/g, '');//先去除千分符
          }else{
            reconciliationTaxRefundRemark="0";
          }

          var ancillaryHousingRemark="";
          if(this.form.ancillaryHousingRemark !=null){
            ancillaryHousingRemark=this.form.ancillaryHousingRemark.replace(/,/g, '');//先去除千分符
          }else{
            ancillaryHousingRemark="0";
          }
          //netPayFinal = Number(netPayRemark) - Number(homeLeaveRefundRemark) - Number(relocationRefundRemark) - Number(reconciliationTaxRefundRemark) - Number(ancillaryHousingRemark);
          netPayFinal = this.accSub(Number(netPayRemark),Number(homeLeaveRefundRemark));
          netPayFinal = this.accSub(Number(netPayFinal),Number(relocationRefundRemark));
          netPayFinal = this.accSub(Number(netPayFinal),Number(reconciliationTaxRefundRemark));
          netPayFinal = this.accSub(Number(netPayFinal),Number(ancillaryHousingRemark));
        }else{
          //LC
          //netPayFinal = Number(netPayRemark) - Number(otherDeductionsRemark);
          netPayFinal = this.accSub(Number(netPayRemark),Number(otherDeductionsRemark));
    ...
    beforesubmit: function() {
      ...
      var me = this;
      this.GL.actUtil.query("get","/eclosingApplicationNew/existOpen/"+this.form.applicantUserId+"?immediateTermination="+this.form.immediateTermination,"",function(data){
      ...
      if(status== 1){
        ...
        //if((processTaskKey=='confirmationParallelUser' || processTaskKey=='confirmationParallel') && this.form.byHrTraining){
          if(!$('#boolRefundTrainingExpense').prop('checked')){
            $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Training Expense Settlement 培训费用清算扣款”。");
            this.form.approvelstatus=false;
            return;
          }else{
            this.form.approvelstatus=true;
        ...
        //if((processTaskKey=='confirmationParallelUser' || this.processTaskKey == 'confirmationParallel' ) && this.form.byHRBP){
          ...
          if(!$('#boolHukouBond').prop('checked')){
            $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Hukou Bond Settlement 户口绑定清算扣款”。");
            this.form.approvelstatus=false;
            return;
          }          
        ...
        if(this.parallelConfirmation && (processTaskKey=='hrcb' || processTaskKey=='hrcb2' || this.form.byHrcb)){
          if(!$('#boolNetPay').prop('checked')){
            $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Salary Before Tax 应付工资（税前）”。");
            this.form.approvelstatus=false;
            return;
          }
          if(this.form.ifFseLe){
            if(this.form.socialInsuranceYear=="" || this.form.socialInsuranceYear==null){
              $.alertApon("Please select the dropdown box for item: 请在事项的下拉框中选择：“Social Insurance by 社会保险至” year 年。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            if(this.form.socialInsuranceMonth=="" || this.form.socialInsuranceMonth==null){
              $.alertApon("Please select the dropdown box for item: 请在事项的下拉框中选择：“Social Insurance by 社会保险至” month 月份。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            ...
            //4个
            if(!$('#boolHomeLeaveRefund').prop('checked')){
              $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Home Leave Refund 探亲假扣款”。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            if(!$('#boolRelocationRefund').prop('checked')){
              $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Relocation Refund 入离职费用扣款”。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            if(!$('#boolReconciliationTaxRefund').prop('checked')){
              $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Reconciliation Tax Refund 个税汇算清缴扣款”。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            if(!$('#boolAncillaryHousing').prop('checked')){
              $.alertApon("Please click in the check box for item: 请在事项的方框里打勾：“Ancillary Housing Service Deduction 房屋附加费扣款”。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
          ...
          if(this.form.ifLc){
            ...
            //Housing Fund by 公积金至
            if(this.form.housingFundYear=="" || this.form.housingFundYear==null){
              $.alertApon("Please select the dropdown box for item: 请在事项的下拉框中选择：“Housing Fund by 公积金至” year 年。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            if(this.form.housingFundMonth=="" || this.form.housingFundMonth==null){
              $.alertApon("Please select the dropdown box for item: 请在事项的下拉框中选择：“Housing Fund by 公积金至” month 月份。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            //Enterprise Annuity by 企业年金至
            if(this.form.enterpriseAnnuityYear=="" || this.form.enterpriseAnnuityYear==null){
              $.alertApon("Please select the dropdown box for item: 请在事项的下拉框中选择：“Enterprise Annuity by 企业年金至” year 年。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
            }
            if(this.form.enterpriseAnnuityMonth=="" || this.form.enterpriseAnnuityMonth==null){
              $.alertApon("Please select the dropdown box for item: 请在事项的下拉框中选择：“Enterprise Annuity by 企业年金至” month 月份。");
              this.form.approvelstatus=false;
              return;
            }else{
              this.form.approvelstatus=true;
    ...
    //表格行删除调用方法
        ...
        if(id) {
          global_.actUtil.query("post", "/eclosingApplicationNew/deleteTraining/"+id, "", function(data) {});
        }
  ...
  data() {
    ...
    if (id) {
      var url = "/form/EclosingApplicationNew/get/" + id;
    } else {
      var url = "/form/EclosingApplicationNew/create/";
    }
    if(this.GL){
    ...
    if(this.$route.query.taskKey != null && dm.form.status==1 ){
      if(this.$route.query.taskKey == 'parallelDirectiveSupervisor' || this.$route.query.taskKey == 'parallelHrbp' 
        ...
        || this.$route.query.taskKey == 'financeAccountant' || this.$route.query.taskKey == 'hrcb' || this.$route.query.taskKey == 'hrcb2' ){
    ...
    // HR C&B hrcbDiv  && this.$route.query.taskKey != null 
    if(dm.parallelConfirmation && (dm.form.byHrcb || this.$route.query.taskKey == 'hrcb' || this.$route.query.taskKey == 'hrcb2')){
      dm.hrcbDisplay=true;
    ...
    if(this.$route.query.taskKey != null && this.$route.query.taskKey == 'financeCashier'){
      dm.otherDeductionDisplay=true;
    }else{
      dm.otherDeductionDisplay=false;
    }
    //dm.otherDeductionDisplay=true;
    ...
    if(this.$route.query.taskKey != null 
      ...
      && this.$route.query.taskKey!='financeCashier'){
    ...
    //Note
    dm.titleParallel="Disciplinary Supervisor、Administration Dept1、Administration Dept2、Administration Dept3、Administration Dept4、HR Dept -Training、HRBP、EHS Dept、EHS Dept -Occupational Physical Examination、IT Dept、HR C&B、Finance Accounting";
    ...
    dm.modelstyle="width:1000px;height:350px;top:60%;";
  ...
  watch: {
    ...
    "form.relocationRefundRemark":{
			handler(curVal,oldVal){
        this.oninputHrcb();
			},
			deep:true
    },
    "form.reconciliationTaxRefundRemark":{
			handler(curVal,oldVal){
        this.oninputHrcb();
			},
			deep:true
    },
    "form.ancillaryHousingRemark":{
			handler(curVal,oldVal){
        this.oninputHrcb();
			},
			deep:true
  ...
  mounted() {
    ...
    //dm.modelstyle="width:1000px;height:350px;top:60%;";
    if(this.form.immediateTermination != null 
      && (this.form.immediateTermination==true || this.form.immediateTermination=='true') 
      || this.form.ifFse){
      this.modelstyle="width:1000px;height:350px;top:60%;";
      console.log("modelstyle="+this.modelstyle);
    }else{
      this.modelstyle="width:1000px;height:350px;top:70%;";
      console.log("modelstyle="+this.modelstyle);
    }
  },
  computed: {
