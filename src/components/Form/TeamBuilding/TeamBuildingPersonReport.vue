				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title"><i class="fa fa-file-text-o"></i> &nbsp;Team Building Application Report (Person) 团队建设申请报告(个人)</h3>
						</div>
						<!-- /.box-header -->
						...
						<div class="box-body">
							...
							<table id="TeamBuildingPersonReport" style="width:200%;"  class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example2_info">
								<thead>
									<tr>
										<th>Staff Code<!-- 工号--></th>
										<th>Name<!-- 姓名--></th>
										<th>Employee Type<!-- 员工类型--></th>
										<th>Department<!-- 部门--></th>
...
<script>
	...
	export default {
		name: "TeamBuildingPersonReport",
		props: ['vclass'],
		methods: {
			draw: function() {
				$("#TeamBuildingPersonReport").DataTable().draw();
			},
			exportexcel: function() {
				

				var url = Config.getBaseURL() + "/teambuilding/exportPersonReportExcel?year=" + this.year +
		...
		mounted() {
			...
			var table = $("#TeamBuildingPersonReport").DataTable({
				"fnServerData": queryData,
				"sAjaxSource": Config.getBaseURL() + "/teambuilding/reportperson",
				"serverSide": true,
				"filter": false,
				"lengthChange": false,
				"aoColumnDefs": [{
					"bSortable": false,
					"aTargets": [1,5,6,8,9,10,12]
				}],
				"aaSorting": [
					[0, "asc"]
				], //给列表排序
