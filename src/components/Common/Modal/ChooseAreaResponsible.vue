	...
	export default {
		...
		methods: {
			...
			popmodal: function() {
				...
				setTimeout(function() {
					$('#selectareaResponsible3'+this.data_index).attr("class", "");//selectotherperson
				}, 300);

			},
			closemodal: function() {
				$('#selectareaResponsible3'+this.data_index).attr("class", "input-group-btn");//selectotherperson
