		...
		mounted(){
			...
			$('#daterangepicker-'+this.currTimes).daterangepicker({
				...
				if(vueComponent.singleDatePicker){
					$('#daterangerpicker-' + this.currTimes).val(start.format('MM/DD/YYYY HH:mm'));
					vueComponent.updateValue(start.format('MM/DD/YYYY HH:mm'));
				}else{
				...
				vueComponent.updateValue(picker.startDate.format('MM/DD/YYYY HH:mm'));
